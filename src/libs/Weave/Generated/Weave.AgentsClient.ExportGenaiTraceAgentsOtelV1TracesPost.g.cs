...
namespace Weave
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Weave.EndPointSecurityRequirement s_ExportGenaiTraceAgentsOtelV1TracesPostSecurityRequirement0 =
        ...
        private static readonly global::Weave.EndPointSecurityRequirement[] s_ExportGenaiTraceAgentsOtelV1TracesPostSecurityRequirements =
            new global::Weave.EndPointSecurityRequirement[]
            {                s_ExportGenaiTraceAgentsOtelV1TracesPostSecurityRequirement0,
            };
        partial void PrepareExportGenaiTraceAgentsOtelV1TracesPostArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareExportGenaiTraceAgentsOtelV1TracesPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessExportGenaiTraceAgentsOtelV1TracesPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExportGenaiTraceAgentsOtelV1TracesPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ExportGenaiTraceAgentsOtelV1TracesPostAsync(
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ExportGenaiTraceAgentsOtelV1TracesPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<string>> ExportGenaiTraceAgentsOtelV1TracesPostAsResponseAsync(
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareExportGenaiTraceAgentsOtelV1TracesPostArguments(
                httpClient: HttpClient);


            var __authorizations = global::Weave.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ExportGenaiTraceAgentsOtelV1TracesPostSecurityRequirements,
                operationName: "ExportGenaiTraceAgentsOtelV1TracesPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareExportGenaiTraceAgentsOtelV1TracesPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ExportGenaiTraceAgentsOtelV1TracesPost",
                                methodName: "ExportGenaiTraceAgentsOtelV1TracesPostAsync",
                                pathTemplate: "\"/agents/otel/v1/traces\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessExportGenaiTraceAgentsOtelV1TracesPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessExportGenaiTraceAgentsOtelV1TracesPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
