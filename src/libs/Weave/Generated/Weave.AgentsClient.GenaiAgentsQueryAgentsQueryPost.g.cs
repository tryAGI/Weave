...
namespace Weave
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Weave.EndPointSecurityRequirement s_GenaiAgentsQueryAgentsQueryPostSecurityRequirement0 =
        ...
        private static readonly global::Weave.EndPointSecurityRequirement[] s_GenaiAgentsQueryAgentsQueryPostSecurityRequirements =
            new global::Weave.EndPointSecurityRequirement[]
            {                s_GenaiAgentsQueryAgentsQueryPostSecurityRequirement0,
            };
        partial void PrepareGenaiAgentsQueryAgentsQueryPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Weave.AgentsQueryReq request);
        partial void PrepareGenaiAgentsQueryAgentsQueryPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Weave.AgentsQueryReq request);
        partial void ProcessGenaiAgentsQueryAgentsQueryPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenaiAgentsQueryAgentsQueryPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.AgentsQueryRes> GenaiAgentsQueryAgentsQueryPostAsync(

            global::Weave.AgentsQueryReq request,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenaiAgentsQueryAgentsQueryPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.AgentsQueryRes>> GenaiAgentsQueryAgentsQueryPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenaiAgentsQueryAgentsQueryPostArguments(
            ...
            var __authorizations = global::Weave.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenaiAgentsQueryAgentsQueryPostSecurityRequirements,
                operationName: "GenaiAgentsQueryAgentsQueryPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenaiAgentsQueryAgentsQueryPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenaiAgentsQueryAgentsQueryPost",
                                methodName: "GenaiAgentsQueryAgentsQueryPostAsync",
                                pathTemplate: "\"/agents/query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenaiAgentsQueryAgentsQueryPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenaiAgentsQueryAgentsQueryPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.AgentsQueryRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.AgentsQueryRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.AgentsQueryRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.AgentsQueryRes> GenaiAgentsQueryAgentsQueryPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Weave.AgentsQueryReq
            {
                ProjectId = projectId,
                Filters = filters,
                SortBy = sortBy,
            ...
            return await GenaiAgentsQueryAgentsQueryPostAsync(
                request: __request,
                requestOptions: requestOptions,
