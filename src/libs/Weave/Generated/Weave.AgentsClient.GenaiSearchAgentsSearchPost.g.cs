...
namespace Weave
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Weave.EndPointSecurityRequirement s_GenaiSearchAgentsSearchPostSecurityRequirement0 =
        ...
        private static readonly global::Weave.EndPointSecurityRequirement[] s_GenaiSearchAgentsSearchPostSecurityRequirements =
            new global::Weave.EndPointSecurityRequirement[]
            {                s_GenaiSearchAgentsSearchPostSecurityRequirement0,
            };
        partial void PrepareGenaiSearchAgentsSearchPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Weave.AgentSearchReq request);
        partial void PrepareGenaiSearchAgentsSearchPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Weave.AgentSearchReq request);
        partial void ProcessGenaiSearchAgentsSearchPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenaiSearchAgentsSearchPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GenaiSearchAgentsSearchPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.AgentSearchRes>> GenaiSearchAgentsSearchPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenaiSearchAgentsSearchPostArguments(
            ...
            var __authorizations = global::Weave.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenaiSearchAgentsSearchPostSecurityRequirements,
                operationName: "GenaiSearchAgentsSearchPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenaiSearchAgentsSearchPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenaiSearchAgentsSearchPost",
                                methodName: "GenaiSearchAgentsSearchPostAsync",
                                pathTemplate: "\"/agents/search\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenaiSearchAgentsSearchPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenaiSearchAgentsSearchPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.AgentSearchRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.AgentSearchRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.AgentSearchRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.AgentSearchRes> GenaiSearchAgentsSearchPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Weave.AgentSearchReq
            {
                ProjectId = projectId,
                Query = query,
                Roles = roles,
            ...
            return await GenaiSearchAgentsSearchPostAsync(
                request: __request,
                requestOptions: requestOptions,
