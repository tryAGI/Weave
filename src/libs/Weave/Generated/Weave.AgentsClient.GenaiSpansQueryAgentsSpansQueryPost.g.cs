...
namespace Weave
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Weave.EndPointSecurityRequirement s_GenaiSpansQueryAgentsSpansQueryPostSecurityRequirement0 =
        ...
        private static readonly global::Weave.EndPointSecurityRequirement[] s_GenaiSpansQueryAgentsSpansQueryPostSecurityRequirements =
            new global::Weave.EndPointSecurityRequirement[]
            {                s_GenaiSpansQueryAgentsSpansQueryPostSecurityRequirement0,
            };
        partial void PrepareGenaiSpansQueryAgentsSpansQueryPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Weave.AgentSpansQueryReq request);
        partial void PrepareGenaiSpansQueryAgentsSpansQueryPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Weave.AgentSpansQueryReq request);
        partial void ProcessGenaiSpansQueryAgentsSpansQueryPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenaiSpansQueryAgentsSpansQueryPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.AgentSpansQueryRes> GenaiSpansQueryAgentsSpansQueryPostAsync(

            global::Weave.AgentSpansQueryReq request,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenaiSpansQueryAgentsSpansQueryPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.AgentSpansQueryRes>> GenaiSpansQueryAgentsSpansQueryPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenaiSpansQueryAgentsSpansQueryPostArguments(
            ...
            var __authorizations = global::Weave.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenaiSpansQueryAgentsSpansQueryPostSecurityRequirements,
                operationName: "GenaiSpansQueryAgentsSpansQueryPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenaiSpansQueryAgentsSpansQueryPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenaiSpansQueryAgentsSpansQueryPost",
                                methodName: "GenaiSpansQueryAgentsSpansQueryPostAsync",
                                pathTemplate: "\"/agents/spans/query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenaiSpansQueryAgentsSpansQueryPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenaiSpansQueryAgentsSpansQueryPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.AgentSpansQueryRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.AgentSpansQueryRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.AgentSpansQueryRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.AgentSpansQueryRes> GenaiSpansQueryAgentsSpansQueryPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Weave.AgentSpansQueryReq
            {
                ProjectId = projectId,
                Query = query,
                GroupBy = groupBy,
                ...
                CustomAttrColumns = customAttrColumns,
