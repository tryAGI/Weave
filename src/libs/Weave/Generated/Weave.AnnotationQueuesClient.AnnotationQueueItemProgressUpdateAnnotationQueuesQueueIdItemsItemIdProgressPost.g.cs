            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Weave.AnnotatorQueueItemsProgressUpdateRes.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Weave.AnnotatorQueueItemsProgressUpdateRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
