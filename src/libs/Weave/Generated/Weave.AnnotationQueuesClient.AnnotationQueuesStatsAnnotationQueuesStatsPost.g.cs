            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Weave.AnnotationQueuesStatsRes.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Weave.AnnotationQueuesStatsRes.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
