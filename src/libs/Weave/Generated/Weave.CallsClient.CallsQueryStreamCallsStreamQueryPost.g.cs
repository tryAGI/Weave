...
namespace Weave
{
    public partial class CallsClient
    {
        ...
        {
            var __response = await CallsQueryStreamCallsStreamQueryPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<string>> CallsQueryStreamCallsStreamQueryPostAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CallsQueryStreamCallsStreamQueryPost",
                                methodName: "CallsQueryStreamCallsStreamQueryPostAsync",
                                pathTemplate: "\"/calls/stream_query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
