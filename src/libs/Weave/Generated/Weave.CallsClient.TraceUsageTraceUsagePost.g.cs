            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Weave.TraceUsageRes.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Weave.TraceUsageRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
