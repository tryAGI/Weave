...
namespace Weave
{
    public partial class CompletionsClient
    {
        ...
        private static readonly global::Weave.EndPointSecurityRequirement s_CompletionsCreateCompletionsCreatePostSecurityRequirement0 =
        ...
        private static readonly global::Weave.EndPointSecurityRequirement[] s_CompletionsCreateCompletionsCreatePostSecurityRequirements =
            new global::Weave.EndPointSecurityRequirement[]
            {                s_CompletionsCreateCompletionsCreatePostSecurityRequirement0,
            };
        partial void PrepareCompletionsCreateCompletionsCreatePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Weave.CompletionsCreateReq request);
        partial void PrepareCompletionsCreateCompletionsCreatePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Weave.CompletionsCreateReq request);
        partial void ProcessCompletionsCreateCompletionsCreatePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCompletionsCreateCompletionsCreatePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.CompletionsCreateRes> CompletionsCreateCompletionsCreatePostAsync(

            global::Weave.CompletionsCreateReq request,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CompletionsCreateCompletionsCreatePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.CompletionsCreateRes>> CompletionsCreateCompletionsCreatePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCompletionsCreateCompletionsCreatePostArguments(
            ...
            var __authorizations = global::Weave.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CompletionsCreateCompletionsCreatePostSecurityRequirements,
                operationName: "CompletionsCreateCompletionsCreatePostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCompletionsCreateCompletionsCreatePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CompletionsCreateCompletionsCreatePost",
                                methodName: "CompletionsCreateCompletionsCreatePostAsync",
                                pathTemplate: "\"/completions/create\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCompletionsCreateCompletionsCreatePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCompletionsCreateCompletionsCreatePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.CompletionsCreateRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.CompletionsCreateRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.CompletionsCreateRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CompletionsCreateCompletionsCreatePostAsync(
                request: __request,
                requestOptions: requestOptions,
