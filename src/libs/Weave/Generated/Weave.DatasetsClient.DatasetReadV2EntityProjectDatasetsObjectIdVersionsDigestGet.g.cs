...
namespace Weave
{
    public partial class DatasetsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.DatasetReadRes> DatasetReadV2EntityProjectDatasetsObjectIdVersionsDigestGetAsync(
            string entity,
            string project,
            string objectId,
            string digest,
        ...
        {
            var __response = await DatasetReadV2EntityProjectDatasetsObjectIdVersionsDigestGetAsResponseAsync(
                entity: entity,
                project: project,
                objectId: objectId,
                digest: digest,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.DatasetReadRes>> DatasetReadV2EntityProjectDatasetsObjectIdVersionsDigestGetAsResponseAsync(
            string entity,
            string project,
            string objectId,
            string digest,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DatasetReadV2EntityProjectDatasetsObjectIdVersionsDigestGet",
                                methodName: "DatasetReadV2EntityProjectDatasetsObjectIdVersionsDigestGetAsync",
                                pathTemplate: "$\"/v2/{entity}/{project}/datasets/{objectId}/versions/{digest}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.DatasetReadRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.DatasetReadRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.DatasetReadRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
