            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Weave.EvalResultsQueryRes.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Weave.EvalResultsQueryRes.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
