...
namespace Weave
{
    public partial class EvalResultsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.EvalResultsQueryRes> EvalResultsQueryV2EntityProjectEvalResultsQueryPostAsync(
            string entity,
            string project,
        ...
        {
            var __response = await EvalResultsQueryV2EntityProjectEvalResultsQueryPostAsResponseAsync(
                entity: entity,
                project: project,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.EvalResultsQueryRes>> EvalResultsQueryV2EntityProjectEvalResultsQueryPostAsResponseAsync(
            string entity,
            string project,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EvalResultsQueryV2EntityProjectEvalResultsQueryPost",
                                methodName: "EvalResultsQueryV2EntityProjectEvalResultsQueryPostAsync",
                                pathTemplate: "$\"/v2/{entity}/{project}/eval_results/query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.EvalResultsQueryRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.EvalResultsQueryRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.EvalResultsQueryRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
