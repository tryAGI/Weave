...
namespace Weave
{
    public partial class EvaluationRunsClient
    {
        ...
        partial void PrepareEvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string entity,
            string project,
            string evaluationRunId);
        partial void ProcessEvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.EvaluationRunReadRes> EvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetAsync(
            string entity,
            string project,
            string evaluationRunId,
        ...
        {
            var __response = await EvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetAsResponseAsync(
                entity: entity,
                project: project,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.EvaluationRunReadRes>> EvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetAsResponseAsync(
            string entity,
            string project,
            string evaluationRunId,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGet",
                                methodName: "EvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.EvaluationRunReadRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.EvaluationRunReadRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.EvaluationRunReadRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
