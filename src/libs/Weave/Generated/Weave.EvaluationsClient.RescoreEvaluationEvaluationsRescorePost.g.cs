...
namespace Weave
{
    public partial class EvaluationsClient
    {
        ...
        private static readonly global::Weave.EndPointSecurityRequirement s_RescoreEvaluationEvaluationsRescorePostSecurityRequirement0 =
        ...
        private static readonly global::Weave.EndPointSecurityRequirement[] s_RescoreEvaluationEvaluationsRescorePostSecurityRequirements =
            new global::Weave.EndPointSecurityRequirement[]
            {                s_RescoreEvaluationEvaluationsRescorePostSecurityRequirement0,
            };
        partial void PrepareRescoreEvaluationEvaluationsRescorePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Weave.RescoreReq request);
        partial void PrepareRescoreEvaluationEvaluationsRescorePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Weave.RescoreReq request);
        partial void ProcessRescoreEvaluationEvaluationsRescorePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRescoreEvaluationEvaluationsRescorePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.RescoreRes> RescoreEvaluationEvaluationsRescorePostAsync(

            global::Weave.RescoreReq request,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await RescoreEvaluationEvaluationsRescorePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.RescoreRes>> RescoreEvaluationEvaluationsRescorePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRescoreEvaluationEvaluationsRescorePostArguments(
            ...
            var __authorizations = global::Weave.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RescoreEvaluationEvaluationsRescorePostSecurityRequirements,
                operationName: "RescoreEvaluationEvaluationsRescorePostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRescoreEvaluationEvaluationsRescorePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RescoreEvaluationEvaluationsRescorePost",
                                methodName: "RescoreEvaluationEvaluationsRescorePostAsync",
                                pathTemplate: "\"/evaluations/rescore\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRescoreEvaluationEvaluationsRescorePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRescoreEvaluationEvaluationsRescorePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.RescoreRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.RescoreRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.RescoreRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.RescoreRes> RescoreEvaluationEvaluationsRescorePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Weave.RescoreReq
            {
            ...
            return await RescoreEvaluationEvaluationsRescorePostAsync(
                request: __request,
                requestOptions: requestOptions,
