...
namespace Weave
{
    public partial class FeedbackClient
    {
        ...
        private static readonly global::Weave.EndPointSecurityRequirement s_FeedbackAggregateFeedbackAggregatePostSecurityRequirement0 =
        ...
        private static readonly global::Weave.EndPointSecurityRequirement[] s_FeedbackAggregateFeedbackAggregatePostSecurityRequirements =
            new global::Weave.EndPointSecurityRequirement[]
            {                s_FeedbackAggregateFeedbackAggregatePostSecurityRequirement0,
            };
        partial void PrepareFeedbackAggregateFeedbackAggregatePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Weave.FeedbackAggregateReq request);
        partial void PrepareFeedbackAggregateFeedbackAggregatePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Weave.FeedbackAggregateReq request);
        partial void ProcessFeedbackAggregateFeedbackAggregatePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFeedbackAggregateFeedbackAggregatePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.FeedbackAggregateRes> FeedbackAggregateFeedbackAggregatePostAsync(

            global::Weave.FeedbackAggregateReq request,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await FeedbackAggregateFeedbackAggregatePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.FeedbackAggregateRes>> FeedbackAggregateFeedbackAggregatePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareFeedbackAggregateFeedbackAggregatePostArguments(
            ...
            var __authorizations = global::Weave.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FeedbackAggregateFeedbackAggregatePostSecurityRequirements,
                operationName: "FeedbackAggregateFeedbackAggregatePostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareFeedbackAggregateFeedbackAggregatePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FeedbackAggregateFeedbackAggregatePost",
                                methodName: "FeedbackAggregateFeedbackAggregatePostAsync",
                                pathTemplate: "\"/feedback/aggregate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFeedbackAggregateFeedbackAggregatePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessFeedbackAggregateFeedbackAggregatePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.FeedbackAggregateRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.FeedbackAggregateRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.FeedbackAggregateRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.FeedbackAggregateRes> FeedbackAggregateFeedbackAggregatePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Weave.FeedbackAggregateReq
            {
                ProjectId = projectId,
                AfterMs = afterMs,
                BeforeMs = beforeMs,
                ...
                ScorerIds = scorerIds,
                SpanAgentNames = spanAgentNames,
                SpanTypes = spanTypes,
                GroupBy = groupBy,
            };

            return await FeedbackAggregateFeedbackAggregatePostAsync(
                request: __request,
                requestOptions: requestOptions,
