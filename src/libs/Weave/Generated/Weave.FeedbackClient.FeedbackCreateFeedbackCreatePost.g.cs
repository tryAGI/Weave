...
namespace Weave
{
    public partial class FeedbackClient
    {
        ...
        partial void PrepareFeedbackCreateFeedbackCreatePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Weave.FeedbackCreateReq request);
        partial void ProcessFeedbackCreateFeedbackCreatePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFeedbackCreateFeedbackCreatePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.FeedbackCreateRes> FeedbackCreateFeedbackCreatePostAsync(

            global::Weave.FeedbackCreateReq request,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await FeedbackCreateFeedbackCreatePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.FeedbackCreateRes>> FeedbackCreateFeedbackCreatePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareFeedbackCreateFeedbackCreatePostArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareFeedbackCreateFeedbackCreatePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FeedbackCreateFeedbackCreatePost",
                                methodName: "FeedbackCreateFeedbackCreatePostAsync",
                                pathTemplate: "\"/feedback/create\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFeedbackCreateFeedbackCreatePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessFeedbackCreateFeedbackCreatePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.FeedbackCreateRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.FeedbackCreateRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.FeedbackCreateRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.FeedbackCreateRes> FeedbackCreateFeedbackCreatePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Weave.FeedbackCreateReq
            {
                Id = id,
                ProjectId = projectId,
                WeaveRef = weaveRef,
                ...
                ScorerTraceId = scorerTraceId,
                WbUserId = wbUserId,
            };

            return await FeedbackCreateFeedbackCreatePostAsync(
                request: __request,
                requestOptions: requestOptions,
