            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Weave.FeedbackReplaceRes.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Weave.FeedbackReplaceRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
