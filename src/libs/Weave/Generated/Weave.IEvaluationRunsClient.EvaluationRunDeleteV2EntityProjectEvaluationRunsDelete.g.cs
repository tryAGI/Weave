...
namespace Weave
{
    public partial interface IEvaluationRunsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.EvaluationRunDeleteRes>> EvaluationRunDeleteV2EntityProjectEvaluationRunsDeleteAsResponseAsync(
            string entity,
            string project,
            global::System.Collections.Generic.IList<string> evaluationRunIds,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
