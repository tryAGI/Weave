...
namespace Weave
{
    public partial interface IEvaluationRunsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.EvaluationRunFinishRes>> EvaluationRunFinishV2EntityProjectEvaluationRunsEvaluationRunIdFinishPostAsResponseAsync(
            string entity,
            string project,
            string evaluationRunId,
