...
namespace Weave
{
    public partial interface IEvaluationRunsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.EvaluationRunReadRes>> EvaluationRunReadV2EntityProjectEvaluationRunsEvaluationRunIdGetAsResponseAsync(
            string entity,
            string project,
            string evaluationRunId,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
