...
namespace Weave
{
    public partial interface IInferenceClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.RouterOpenRouterModelsRes>> InferenceRouterOpenrouterModelsInferenceRouterOpenrouterModelsGetAsResponseAsync(
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
}