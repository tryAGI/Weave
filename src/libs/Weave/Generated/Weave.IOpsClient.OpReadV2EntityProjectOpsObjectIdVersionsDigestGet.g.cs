...
namespace Weave
{
    public partial interface IOpsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.OpReadRes>> OpReadV2EntityProjectOpsObjectIdVersionsDigestGetAsResponseAsync(
            string entity,
            string project,
            string objectId,
            string digest,
