...
namespace Weave
{
    public partial interface IPredictionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.PredictionReadRes>> PredictionReadV2EntityProjectPredictionsPredictionIdGetAsResponseAsync(
            string entity,
            string project,
            string predictionId,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
