...
namespace Weave
{
    public partial interface IScorersClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.ScorerCreateRes>> ScorerCreateV2EntityProjectScorersPostAsResponseAsync(
            string entity,
            string project,
