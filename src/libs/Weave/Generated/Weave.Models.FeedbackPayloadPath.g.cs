...
namespace Weave
{
    ...
    public sealed partial class FeedbackPayloadPath
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Weave.JsonConverters.FeedbackPayloadPathValueTypeJsonConverter))]
        public global::Weave.FeedbackPayloadPathValueType? ValueType { get; set; }
        ...
        public FeedbackPayloadPath(
            string jsonPath,
            global::Weave.FeedbackPayloadPathValueType? valueType)
        {
