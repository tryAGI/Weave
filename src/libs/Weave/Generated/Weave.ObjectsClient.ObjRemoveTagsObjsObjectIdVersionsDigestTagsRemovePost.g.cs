            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Weave.ObjRemoveTagsRes.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Weave.ObjRemoveTagsRes.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
