            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Weave.TagsListRes.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Weave.TagsListRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
