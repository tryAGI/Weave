...
namespace Weave
{
    ...
    /// </summary>
    public sealed class ObservabilityIngestionLifecycle : global::System.IAsyncDisposable, global::System.IDisposable
    {
        ...
        public ObservabilityIngestionLifecycle(
            ...
            ObservabilityIngestionOptions? options = null)
        {
            ...
            if (Options.Enabled && Options.FlushInterval > global::System.TimeSpan.Zero)
            {
                _timer = new global::System.Threading.Timer(
                    static state => _ = ((ObservabilityIngestionLifecycle)state!).FlushInBackgroundAsync(),
                    this,
        ...
        private void ThrowIfDisposed()
        {
            if (_disposed)
            {
                throw new global::System.ObjectDisposedException(nameof(ObservabilityIngestionLifecycle));
            }
        }
    }
}
