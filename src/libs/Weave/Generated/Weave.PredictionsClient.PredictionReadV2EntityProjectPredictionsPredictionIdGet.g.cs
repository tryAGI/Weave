...
namespace Weave
{
    public partial class PredictionsClient
    {
        ...
        partial void PreparePredictionReadV2EntityProjectPredictionsPredictionIdGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string entity,
            string project,
            string predictionId);
        partial void ProcessPredictionReadV2EntityProjectPredictionsPredictionIdGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPredictionReadV2EntityProjectPredictionsPredictionIdGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.PredictionReadRes> PredictionReadV2EntityProjectPredictionsPredictionIdGetAsync(
            string entity,
            string project,
            string predictionId,
        ...
        {
            var __response = await PredictionReadV2EntityProjectPredictionsPredictionIdGetAsResponseAsync(
                entity: entity,
                project: project,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.PredictionReadRes>> PredictionReadV2EntityProjectPredictionsPredictionIdGetAsResponseAsync(
            string entity,
            string project,
            string predictionId,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PreparePredictionReadV2EntityProjectPredictionsPredictionIdGetArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePredictionReadV2EntityProjectPredictionsPredictionIdGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PredictionReadV2EntityProjectPredictionsPredictionIdGet",
                                methodName: "PredictionReadV2EntityProjectPredictionsPredictionIdGetAsync",
                                pathTemplate: "$\"/v2/{entity}/{project}/predictions/{predictionId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPredictionReadV2EntityProjectPredictionsPredictionIdGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPredictionReadV2EntityProjectPredictionsPredictionIdGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.PredictionReadRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.PredictionReadRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.PredictionReadRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
