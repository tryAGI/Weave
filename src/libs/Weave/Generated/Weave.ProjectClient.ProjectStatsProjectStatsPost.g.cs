...
namespace Weave
{
    public partial class ProjectClient
    {
        ...
        private static readonly global::Weave.EndPointSecurityRequirement s_ProjectStatsProjectStatsPostSecurityRequirement0 =
        ...
        private static readonly global::Weave.EndPointSecurityRequirement[] s_ProjectStatsProjectStatsPostSecurityRequirements =
            new global::Weave.EndPointSecurityRequirement[]
            {                s_ProjectStatsProjectStatsPostSecurityRequirement0,
            };
        partial void PrepareProjectStatsProjectStatsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Weave.ProjectStatsReq request);
        partial void PrepareProjectStatsProjectStatsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Weave.ProjectStatsReq request);
        partial void ProcessProjectStatsProjectStatsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProjectStatsProjectStatsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.ProjectStatsRes> ProjectStatsProjectStatsPostAsync(

            global::Weave.ProjectStatsReq request,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ProjectStatsProjectStatsPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.ProjectStatsRes>> ProjectStatsProjectStatsPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareProjectStatsProjectStatsPostArguments(
            ...
            var __authorizations = global::Weave.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProjectStatsProjectStatsPostSecurityRequirements,
                operationName: "ProjectStatsProjectStatsPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareProjectStatsProjectStatsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProjectStatsProjectStatsPost",
                                methodName: "ProjectStatsProjectStatsPostAsync",
                                pathTemplate: "\"/project/stats\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessProjectStatsProjectStatsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProjectStatsProjectStatsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.ProjectStatsRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.ProjectStatsRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.ProjectStatsRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.ProjectStatsRes> ProjectStatsProjectStatsPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Weave.ProjectStatsReq
            {
                ProjectId = projectId,
                IncludeTraceStorageSize = includeTraceStorageSize,
                IncludeObjectStorageSize = includeObjectStorageSize,
                IncludeTableStorageSize = includeTableStorageSize,
                IncludeFileStorageSize = includeFileStorageSize,
            };

            return await ProjectStatsProjectStatsPostAsync(
                request: __request,
                requestOptions: requestOptions,
