...
namespace Weave
{
    public partial class RegistryClient
    {
        ...
        private static readonly global::Weave.EndPointSecurityRequirement s_LinkToRegistryLinkToRegistryPostSecurityRequirement0 =
        ...
        private static readonly global::Weave.EndPointSecurityRequirement[] s_LinkToRegistryLinkToRegistryPostSecurityRequirements =
            new global::Weave.EndPointSecurityRequirement[]
            {                s_LinkToRegistryLinkToRegistryPostSecurityRequirement0,
            };
        partial void PrepareLinkToRegistryLinkToRegistryPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Weave.CreateAndLinkPayload request);
        partial void PrepareLinkToRegistryLinkToRegistryPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Weave.CreateAndLinkPayload request);
        partial void ProcessLinkToRegistryLinkToRegistryPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessLinkToRegistryLinkToRegistryPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.CreateAndLinkWeaveAssetRes> LinkToRegistryLinkToRegistryPostAsync(

            global::Weave.CreateAndLinkPayload request,
            global::Weave.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await LinkToRegistryLinkToRegistryPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Weave.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Weave.AutoSDKHttpResponse<global::Weave.CreateAndLinkWeaveAssetRes>> LinkToRegistryLinkToRegistryPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareLinkToRegistryLinkToRegistryPostArguments(
            ...
            var __authorizations = global::Weave.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_LinkToRegistryLinkToRegistryPostSecurityRequirements,
                operationName: "LinkToRegistryLinkToRegistryPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareLinkToRegistryLinkToRegistryPostRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Weave.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Weave.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "LinkToRegistryLinkToRegistryPost",
                                methodName: "LinkToRegistryLinkToRegistryPostAsync",
                                pathTemplate: "\"/link_to_registry\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessLinkToRegistryLinkToRegistryPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Weave.CreateAndLinkWeaveAssetRes.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Weave.AutoSDKHttpResponse<global::Weave.CreateAndLinkWeaveAssetRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Weave.CreateAndLinkWeaveAssetRes.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Weave.CreateAndLinkWeaveAssetRes> LinkToRegistryLinkToRegistryPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Weave.CreateAndLinkPayload
            {
                Ref = @ref,
                Target = target,
                Aliases = aliases,
            ...
            return await LinkToRegistryLinkToRegistryPostAsync(
                request: __request,
                requestOptions: requestOptions,
