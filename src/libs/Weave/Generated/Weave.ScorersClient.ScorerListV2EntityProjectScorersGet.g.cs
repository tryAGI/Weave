...
namespace Weave
{
    public partial class ScorersClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Weave.ScorerReadRes> ScorerListV2EntityProjectScorersGetAsync(
            string entity,
            string project,
                ...
                else
                {
                    await global::Weave.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            while (!__reader.EndOfStream && !__effectiveCancellationToken.IsCancellationRequested)
                            {
                                ...
                                var __streamedResponse = global::Weave.ScorerReadRes.FromJson(__content, JsonSerializerContext) ??
                                                       throw global::Weave.ApiException.Create(
                                                           statusCode: __response.StatusCode,
